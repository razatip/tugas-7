...
$katapertama = "Hello PHP!"; // Panjang string 10, jumlah kata: 2
$katakedua = "I'm ready for the challenges"; // Panjang string: 28, jumlah kata: 5 
echo $katapertama . " panjang string " . strlen($katapertama) . " jumlah kata " . str_word_count($katapertama) . "<br>";
echo $katakedua . " panjang string " . strlen($katakedua) . " jumlah kata " . str_word_count($katakedua) . "<br>";
